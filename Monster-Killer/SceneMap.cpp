...
{
	LoadObj(&m_file, 1.0, GLM_TEXTURE, ".\\res\\Map\\SceneMap.obj");
	LoadTexture(&m_texture, ".\\res\\Map\\SceneTexture.png");
	LoadSceneData(&m_data, ".\\res\\Map\\SceneData.hmp");
}
...
{
	return (LoadTexture(&m_aerialTexture, ".\\res\\Map\\AerialScene.png") && LoadTexture(&m_monLocation, ".\\res\\Map\\Red_Arrow_Up.png") && LoadTexture(&m_masLocation, ".\\res\\Map\\Green_Arrow_Up.png"));
}
